...
// Polyfill for Request, Response, and Headers objects for Jest's JSDOM environment.
...
// Use Node.js's native fetch API if available (Node.js 18+)
// Otherwise, provide a minimal polyfill.
